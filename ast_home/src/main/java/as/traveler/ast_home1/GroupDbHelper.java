...
public class GroupDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_FILE = "friends", DB_TABLE = "grp";// 資料庫物件，固定的欄位變數
    ...
    public static SQLiteDatabase getDatabase(Context context) {
        if (database == null || !database.isOpen()){
            database = new FriendDbOpenHelper(context, DB_FILE, null, VERSION).getWritableDatabase();
        }
        return database;
    }
