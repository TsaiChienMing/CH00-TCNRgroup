...
public class AttractionContentProvider extends ContentProvider {
    private static final String AUTHORITY = "as.traveler.ast_act1001";
    private static final String DB_FILE = "friends.db", DB_TABLE = "attraction";
