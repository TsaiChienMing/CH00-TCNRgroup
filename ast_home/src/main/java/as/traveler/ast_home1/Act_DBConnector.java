...
public class Act_DBConnector {
    ...
    public static String executeQuery(String query_string) {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost(connect_ip + ".php");
...
//----------------------------------------
    ...
    public static String executeDelet(String delete_from_collection_, ArrayList<NameValuePair> nameValuePairs) {
